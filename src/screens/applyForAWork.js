...
class ApplyForAWorkScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      user_id:0,
      ...
      <Container>
        <Header style={COMMONSTYLES.headerBackgroundColor}>
          ...
          <Body style={STYLES.headerText}>
            <Text style={COMMONSTYLES.header}>LIKE TO WORK ?</Text>
          </Body>
...
export default connect(mapStateToProps, mapDispatchToProps)(ApplyForAWorkScreen);

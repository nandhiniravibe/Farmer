...
class WhetherScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showPassword: true,
      ...
      <Container>
        <Header style={COMMONSTYLES.headerBackgroundColor}>
          ...
          <Body style={STYLES.headerText}>
            <Text style={COMMONSTYLES.header}>WHETHER</Text>
          </Body>
        </Header>
        <Content>
        </Content>
...
export default connect(mapStateToProps, mapDispatchToProps)(WhetherScreen);
